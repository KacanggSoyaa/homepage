...
// Array of project objects displayed in the Projects section.
// Each project has: id (unique key), title, description, stack (tech used),
// github (repo URL), demo (live URL).
